...
import com.example.julienelkaim.testyoutube.EmojiconRecentsManager;
...
import static com.example.julienelkaim.testyoutube.emoji.People.*;
	...
	private View createCustomView() {
		...
		mEmojisAdapter = new EmojisPagerAdapter(
				Arrays.asList(
						...
						new EmojiconGridView(mContext, DATA, recents, this),
